...
print <<EOF
set enableControl 0
START: op add currentLink currentLink 1
...
jump START greaterThan locked \@tick
...
# read if I'm older
print "jump START always x false\n";
print "READCELL: ";
for (@fields) {
...
print "op add enableMultiplier enableControl 1\n";
print "op mul itemCapacity itemCapacity enableMultiplier\n";
